...
import com.github.ontio.common.Out;
...
public abstract class Blockchain implements AutoCloseable {
     ...
     */
    public static Address getMinerAddress(ECPoint[] miners) {
        return Address.addressFromMultiPubKeys(miners.length - (miners.length - 1) / 3, miners);
    }
