    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (sdk.getWalletMgr().getAccounts().size() < 3) {
                info1 = sdk.getWalletMgr().createAccountFromPriKey("111111", "015225b1d934deb6c3f2ebe4b9b50aa434bfb1b7cb6596b992b67c94c4cbcd1b");
...
//            System.exit(0);
            ...
            System.out.println("info1 : ong :" + sdk.nativevm().ont().sendBalanceOf("ong",info1.address));
            System.out.println("info2 : ong :" + sdk.nativevm().ont().sendBalanceOf("ong",info2.address));
            System.out.println("info3 : ong :" + sdk.nativevm().ont().sendBalanceOf("ong",info3.address));
