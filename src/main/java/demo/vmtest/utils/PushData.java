...
public class PushData {
    ...
    public static VMState opJmp(ExecutionEngine engine){
        int offset = engine.Context.OpReader.readVarInt();
    ...
    public static VMState opFromAltStack(ExecutionEngine engine){
        Push(engine,engine.AltStack.Pop());
        return VMState.NONE;
    }
...
//    }
    ...
    public static VMState opBigIntComp(ExecutionEngine engine){
        BigInteger x2 = PopBigInt(engine);
        BigInteger x1 = PopBigInt(engine);
        boolean b =BigIntMultiComp(x2,x1,engine.OpCode);
        PushData(engine,b);
        return VMState.NONE;
    }
    ...
    public static Interop PopInteropInterface(ExecutionEngine engine){
    ...
    public static Interop PeekInteropInterface(ExecutionEngine engine){
        return engine.EvaluationStack.Pop().GetInterface();
    }
