...
public class WasmDemo {
    ...
    public static void main(String[] args){
        try {
            ...
            if(false) {
                Transaction tx = ontSdk.vm().makeDeployCodeTransaction(code, true, "name", "1.0", "1", "1", "1",identity.ontid,0,0);
...
//            System.exit(0);
            ...
            Transaction tx = ontSdk.vm().makeInvokeCodeTransaction(ontSdk.vm().getCodeAddress(),"add",params.getBytes(),null,0,0);
