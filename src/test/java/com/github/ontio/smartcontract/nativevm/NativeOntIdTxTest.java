...
public class NativeOntIdTxTest {
    ...
    public void sendAddPubkey() throws Exception {
        ...
        ontSdk.nativevm().ontId().sendAddPubKey(identity.ontid,password,info2.pubkey,payerAcc.address,password,0);
        ...
        ontSdk.nativevm().ontId().sendRemovePubKey(identity.ontid,password,info2.pubkey,payerAcc.address,password,0);
        Thread.sleep(6000);
    ...
    public void sendAddAttributes() throws Exception {
        ...
        ontSdk.nativevm().ontId().sendAddAttributes(identity.ontid,password,attrsMap2,payerAcc.address,password,0);
        ...
        ontSdk.nativevm().ontId().sendRemoveAttribute(identity.ontid,password,"key99",payerAcc.address,password,0);
        Thread.sleep(6000);
    ...
    public void sendAddRecovery() throws Exception {
        ...
        ontSdk.nativevm().ontId().sendAddRecovery(identity2.ontid,password,info.addressBase58,payerAcc.address,password,0);
        ...
        ontSdk.nativevm().ontId().sendChangeRecovery(identity2.ontid,info2.addressBase58,info.addressBase58,password,0);
        Thread.sleep(6000);
